...
double integrate_by_trapezoidal_rule(double a, double b, double step, double (*f)(double))
{
    /*
     * TODO:
     * Calculate the definite integral of function 'f' from 'a' to 'b'
...
int main(int argc, char** argv)
{
    ...
    if(strcmp(argv[1],"sin")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, sin));
    else if(strcmp(argv[1],"cos")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, cos));
    else if(strcmp(argv[1],"tan")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, tan));
    else if(strcmp(argv[1],"sinh")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, sinh));
    else if(strcmp(argv[1],"cosh")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, cosh));
    else if(strcmp(argv[1],"tanh")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, tanh));
    else if(strcmp(argv[1],"asin")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, asin));
    else if(strcmp(argv[1],"acos")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, acos));
    else if(strcmp(argv[1],"atan")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, atan));
    else if(strcmp(argv[1],"exp")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, exp));
    else if(strcmp(argv[1],"log")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, log));
    else if(strcmp(argv[1],"sqrt")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, sqrt));
    else if(strcmp(argv[1],"user")==0)
        printf("%0.4lf\n", integrate_by_trapezoidal_rule(lower_limit, upper_limit, step, my_function));
    else
